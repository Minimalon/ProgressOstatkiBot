...
***pcNumber*** -  номер компа без дефиза, то есть если номер компа "1798-1" то pcNumber это только "1798".   
***len(pcNumber)*** - количество символов в номере компьютера. Например в "1798" 4 символа.   
***count_busy_barcode*** - Количество до этого сгенерированных штрихкодов   
***barcode*** - штрихкод
